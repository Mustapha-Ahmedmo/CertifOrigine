  ...
  return (
    <nav className="menu">
      <ul>
        ...
        <li 
          onMouseEnter={() => handleMouseEnter('facturations')}
          onMouseLeave={() => handleMouseLeave('facturations')}
        >
          <span className={`menu-title ${openMenu.facturations ? 'open' : ''}`}>
            <FontAwesomeIcon icon={faFileInvoiceDollar} className="icon" /> Mes facturations
          </span>
          {openMenu.facturations && (
            <ul className="submenu">
              <li>
                <Link to="/facturations/list" className={activeLink === 'listFacturations' ? 'active' : ''} onClick={() => handleLinkClick('facturations', 'listFacturations')}>Liste des factures</Link>
              </li>
            </ul>
          )}
        </li>
