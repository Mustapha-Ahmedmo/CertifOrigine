...
RETURNS TABLE(
    id_order INT,
    id_cust_account INT,
    cust_name VARCHAR(128),  -- New field added here
    order_title VARCHAR(32),
    id_order_status INT,
    idlogin_owner INT,
    idlogin_spare INT,
...
BEGIN
    ...
    SELECT 
        o."id_order",
        o."id_cust_account",
        ca."cust_name" AS cust_name,  -- New column added here
        o."order_title",
        o."id_order_status",
        o."idlogin_owner",
        o."idlogin_spare",
    ...
    FROM 
        "ORDER" o
        INNER JOIN CUST_ACCOUNT ca ON o."id_cust_account" = ca."id_cust_account"
        INNER JOIN CUST_USER cu ON ca."id_cust_account" = cu."id_cust_account"
        INNER JOIN ORDER_STATUS os ON o."id_order_status" = os."id_order_status"
        LEFT JOIN ORD_CERTIF_ORI oco ON o."id_order" = oco."id_order"
        LEFT JOIN RECIPIENT_ACCOUNT r ON oco."id_recipient_account" = r."id_recipient_account"
        LEFT JOIN SERVICES_CHARGES sc ON o."typeof" = sc."typeof"
    ...
    WHERE 
        (p_id_order_list IS NULL OR o."id_order" = ANY(string_to_array(p_id_order_list, ',')::INT[]))
        AND (p_id_cust_account_list IS NULL OR o."id_cust_account" = ANY(string_to_array(p_id_cust_account_list, ',')::INT[]))
        AND (p_id_order_status_list IS NULL OR o."id_order_status" = ANY(string_to_array(p_id_order_status_list, ',')::INT[]))
