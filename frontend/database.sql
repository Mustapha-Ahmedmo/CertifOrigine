...
BEGIN
    ...
    FROM 
        "ORDER" o
        LEFT JOIN CUST_ACCOUNT    ca  ON o."id_cust_account"   = ca."id_cust_account"
    ...
    WHERE
      ...
      AND
      (p_id_custaccount_list  IS NULL OR o."id_cust_account" = ANY(string_to_array(p_id_custaccount_list, ',' )::INT[]))
      AND
      (p_id_orderstatus_list  IS NULL OR o."id_order_status" = ANY(string_to_array(p_id_orderstatus_list, ',')::INT[]))
      AND
      (
